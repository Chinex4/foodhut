...
export default function RiderEditProfileScreen() {
  ...
  const [name, setName] = useState(mockRiderProfile.name);
  const [phone, setPhone] = useState(mockRiderProfile.phone);
  const [email, setEmail] = useState(mockRiderProfile.email);
